...
# ---------------------------------------------------------------------------
# Tesseract OCR — configured directly for this Windows installation
# ---------------------------------------------------------------------------
# Your installed Tesseract is:
# C:\\Program Files\\Tesseract-OCR\\tesseract.exe
TESSERACT_PATH = r"C:\\Program Files\\Tesseract-OCR\\tesseract.exe"

# Fall back to PATH only if the standard installation path is unavailable.
if not os.path.isfile(TESSERACT_PATH):
    TESSERACT_PATH = shutil.which("tesseract")

OCR_AVAILABLE = bool(TESSERACT_PATH and os.path.isfile(TESSERACT_PATH))

if OCR_AVAILABLE:
    pytesseract.pytesseract.tesseract_cmd = TESSERACT_PATH
    try:
        # Verify that Python can actually execute Tesseract.
...
def extract_from_image(file_bytes):
    ...
    try:
        ...
        # Improve OCR accuracy for trading screenshots/tables.
        # Upscaling helps Tesseract read small price/date text.
        if img.width < 1800:
